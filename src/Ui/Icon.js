...
export class ArrowLeft extends React.Component {
    render () {
        ...
        return (
            <svg onClick={onHandleClick} className="imageSlider__arrowLeft" width="48" height="80" viewBox="0 0 48 80" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export class ArrowRight extends React.Component {
    render () {
        const {onHandleClick} = this.props;
        return (
            <svg onClick={onHandleClick} className="imageSlider__arrowRight" width="48" height="80" viewBox="0 0 48 80" fill="none" xmlns="http://www.w3.org/2000/svg">
